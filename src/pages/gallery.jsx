  ...
  return (
    <main className="Gallery">
      ...
      <div className="galleryDiv">
        ...
        <img className="galleryImg" src="https://www.ctpethiopia.com/uploads/1/2/1/1/121100825/img-3557_orig.jpg" alt="image3"/>
        <img className="galleryImg" src="https://www.ctpethiopia.com/uploads/1/2/1/1/121100825/img-3757_3_orig.jpg" alt="image5"/>
        <img className="galleryImg" src="https://www.ctpethiopia.com/uploads/1/2/1/1/121100825/editor/img-3499.jpg?1553897886" alt="image4"/>
        <img className="galleryImg" src="https://www.ctpethiopia.com/uploads/1/2/1/1/121100825/img-3471_orig.jpg" alt="image6"/>
